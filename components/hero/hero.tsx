      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-4 sm:py-8 lg:py-12">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 light:text-gray-600 ring-1 light:ring-gray-900/10 light:hover:ring-gray-900/20">
              Discover the Easiest Way to Book Venues.{" "}
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight light:text-gray-900 sm:text-6xl">
              Effortless venue booking
            </h1>
            <p className="mt-6 text-lg leading-8 dark:text-neutral-300 light:text-gray-600">
              VenueHub simplifies the process of finding and booking the perfect venue for your events. Discover and
              reserve venues with ease.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <Link href="/venues" className="text-sm font-semibold leading-6 light:text-gray-900">
